...
description: >-
  ...
  everything, fixes it once, and verifies the result: parallel Codex + bug/security hunters +
...
| `logic` hunter (business logic, broken flows) | – | – | ✅ |
