...
`--herdr` is the one optional tool whose absence is a **stop** rather than a named skip, and only
...
`agent-browser` 0.26.0 · `tmux` 3.7b · `herdr` 0.9.0 · Claude Code 2.1.220.
