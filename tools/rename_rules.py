...
PACK_NATIVE = frozenset({"issues-draft", "pack-maintain", "plan-report", "plan-run",
                         "plan-unblock", "reuse-index", "task-quick", "ui-prototype"})
...
NO_AUTO_FIRE = {"task-run", "issues-fix", "plan-run", "task-quick"}
